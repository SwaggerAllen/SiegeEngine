...
Cohort regenerate was retired alongside the v3 authoring-skill
suite — iteration cycles now drive from Claude Code skills against
the local repo, not a server endpoint.

The remaining workflow:
1. Browse the per-tier structure-summary.
2. Hit auto-suggest or hand-pick comp IDs.
3. POST a Cohort (save the selection).
4. Drive iteration cycles via the regen-* skills in Claude Code.
