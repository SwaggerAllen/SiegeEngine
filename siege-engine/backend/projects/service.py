...
def create_project(
    ...
    # v3 migration: per-tier generation moved to Claude Code skills.
    # Project creation now lands the project row + input document and
    # stops — the user kicks off /draft-feature-expansion (etc.) from
    # their CC session.
