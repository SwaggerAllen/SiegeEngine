...
Run with ``python -m siege_mcp.cli <subcommand> --help`` for per-command
flags.
"""
...
from siege_mcp.validate import validate_artifact
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="siege_mcp.cli")
