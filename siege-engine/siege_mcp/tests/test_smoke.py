"""Smoke tests for the siege_mcp substrate.
...
from siege_mcp import fragments, validate


def test_state_round_trip():
    from siege_mcp.state import Scope, State, dump_state, parse_state
...
def test_fragment_layer_lookup():
    from siege_mcp.fragments import (
