...
describe('StageNode', () => {
  ...
  it('renders the node label', () => {
    render(<StageNode data={baseData} />);
  ...
  it('does not show spinner for pending status', () => {
    const { container } = render(<StageNode data={baseData} />);
