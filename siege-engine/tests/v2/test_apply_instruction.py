...
class TestCreate:
    ...
    def test_defaults_kind_to_domain_when_no_parent(self, db, project):
        # Create no longer accepts tier="feat" — feat authoring lives
        # in the v3 substrate via /propose_feature and /add_feature.
        # Use tier="comp" for the kind-default check.
        apply_mod.dispatch_instruction(
            db,
            project.id,
