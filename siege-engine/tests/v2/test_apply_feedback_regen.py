...
def _valid_sysarch_output(resp_id: str) -> str:
    return (
        ...
        "<testing>pytest integration drain.</testing>"
        ...
        "<purpose>Owns the project root and shared utilities.</purpose>"
        "<owned-invariants>"
        "<invariant>a single source of truth for settings</invariant>"
        ...
        "<operation>expose the application factory</operation>"
        "</primary-operations>"
